package com.np.suprimpoudel.graphics_overlay.graphics
...
import com.np.suprimpoudel.graphics_overlay.vision.GraphicOverlay
import java.util.*
...
class FaceGraphic constructor(overlay: GraphicOverlay?, private val face: Face) :
    ...
    override fun draw(canvas: Canvas) {
        ...
        canvas.drawText("EulerX: " + face.headEulerAngleX,
            left,
            top + yLabelOffset,
            idPaints[colorID])
        yLabelOffset += lineHeight
        canvas.drawText("EulerY: " + face.headEulerAngleY,
            left,
            top + yLabelOffset,
            idPaints[colorID])
        yLabelOffset += lineHeight
        canvas.drawText("EulerZ: " + face.headEulerAngleZ,
            left,
            top + yLabelOffset,
            idPaints[colorID])
